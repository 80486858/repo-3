...
// Source: pkg/azureclients/privatednsclient/interface.go
//
// Generated by this command:
//
//	mockgen -copyright_file=/home/runner/work/repo-3/repo-3/hack/boilerplate/boilerplate.generatego.txt -source=pkg/azureclients/privatednsclient/interface.go -package=mockprivatednsclient Interface
//

// Package mockprivatednsclient is a generated GoMock package.
package mockprivatednsclient
...
func (mr *MockInterfaceMockRecorder) CreateOrUpdate(ctx, resourceGroupName, privateZoneName, parameters, etag, waitForCompletion any) *gomock.Call {
...
func (mr *MockInterfaceMockRecorder) Get(ctx, resourceGroupName, privateZoneName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
