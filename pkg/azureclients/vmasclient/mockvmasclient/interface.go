...
// Source: pkg/azureclients/vmasclient/interface.go
//
// Generated by this command:
//
//	mockgen -copyright_file=/home/runner/work/repo-3/repo-3/hack/boilerplate/boilerplate.generatego.txt -source=pkg/azureclients/vmasclient/interface.go -package=mockvmasclient Interface
//

// Package mockvmasclient is a generated GoMock package.
package mockvmasclient
...
func (m *MockInterface) Get(ctx context.Context, resourceGroupName, VMScaleSetName string) (compute.AvailabilitySet, *retry.Error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) List(ctx context.Context, resourceGroupName string) ([]compute.AvailabilitySet, *retry.Error) {
	m.ctrl.T.Helper()
