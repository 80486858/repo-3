...
//
//	mockgen -copyright_file=/home/runner/work/repo-3/repo-3/hack/boilerplate/boilerplate.generatego.txt -source=pkg/azureclients/virtualnetworklinksclient/interface.go -package=mockvirtualnetworklinksclient Interface
//
...
func (mr *MockInterfaceMockRecorder) CreateOrUpdate(ctx, resourceGroupName, privateZoneName, virtualNetworkLinkName, parameters, etag, waitForCompletion any) *gomock.Call {
...
func (mr *MockInterfaceMockRecorder) Get(ctx, resourceGroupName, privateZoneName, virtualNetworkLinkName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
